        ...
        <div id="accForm"  style="display: none">
            <div class="d-flex justify-content-center">
             ...
             <div class="d-flex justify-content-center" style="margin-top:20px;">
                <form class="form-inline" id='fearNot'>
                    <div class="form-group">
                        <label for="inputPassword2" class=" gimmeSomeSpace">Novo Acessório</label>
                        <input type="text" class="form-control gimmeSomeSpace" id="accName" placeholder="Nome">
                    </div>
                    <button class="btn btn-outline-success gimmeSomeSpace" type="button" id="addButton">Cadastrar</button>
